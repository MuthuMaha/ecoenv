...
<head>
    ...
    <link href="{{ asset('css/nivo-default.css') }}" rel="stylesheet">
                ...
                <div class="navbar-wrapper">
                    <div id="navbar" class="collapse navbar-collapse pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" >Donate <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu">
                                    <li><a href="blog.html">Trust donation</a></li>
                                    <li><a href="blog-details.html">Hospital donation</a></li>
                                </ul>
                            </li>
                            <li><a href="#couple">Bio gas</a></li>
                           <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" >Rooftop <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu">
                                    <li><a href="blog.html">Gardening</a></li>
                                    <li><a href="blog-details.html">Healthy Home</a></li>
                                </ul>
                            </li>
                            <li><a href="#gallery">Kids education on growth</a></li>
                            <li><a href="#gift-registry">Career</a></li>
                           <!--  <li> @if (Route::has('register'))
                            <a href="{{ route('register') }}" style="float: right"><i class="fa fa-registered" aria-hidden="true"></i></a>
                        @endif</li> -->
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" >Health <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu">
                                    <li><a href="blog.html">Home remedies</a></li>
                                    <li><a href="blog-details.html">Cheap and best env products</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <button class="tog-nav">
                       @if (Route::has('login'))
                <div class="top-right links">
                    @auth
                        <a href="{{ url('/home') }}"><i class="fa fa-home" aria-hidden="true"></i></a>
                    @else
                        <a href="{{ route('login') }}" style="float: left"><i class="fa fa-sign-in" aria-hidden="true"></i></a> 
            ...
            <div class="row">
                <div class="col col-md-9">
                    <div class="button-group pull-left">
                        ...
                        <a href="#" class="millde"><i class="fa fa-map-marker"></i></a>
                    ...
                    <div class="search pull-left">
                        <form>
                            ...
                            <button type="submit" class="btn btn-default"><i class="fa fa-search"></i> <span>&nbsp;Donate now</span></button>
                        </form>
                    </div>
                </div>
        ...
        <div class="container" style="margin-bottom: -25%;">
            <div class="section-title row">
                <div class="col col-md-4 col-md-offset-5">
                    <span style="color: darkgreen">Create Beautiful ENV arround you!</span>
                    <h2>Healthy Life</h2>
                    <p>Perfect website for modern life</p>
                </div>
    ...
    <footer>
        <div class="footer-wrapper">
            <div class="container">
                <div class="title">
                    <h2>EcoEnv</h2>
                    <p>We are ready to help you to create healthy life</p>
                </div>
